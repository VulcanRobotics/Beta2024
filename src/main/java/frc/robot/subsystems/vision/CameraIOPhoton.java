...
import static frc.robot.Constants.Vision.kCameraNameBL;
import static frc.robot.Constants.Vision.kCameraNameBR;
import static frc.robot.Constants.Vision.kCameraNameFL;
import static frc.robot.Constants.Vision.kCameraNameFR;
import static frc.robot.Constants.Vision.kMultiTagStdDevs;
import static frc.robot.Constants.Vision.kRobotToCamBL;
import static frc.robot.Constants.Vision.kRobotToCamBR;
import static frc.robot.Constants.Vision.kRobotToCamFL;
import static frc.robot.Constants.Vision.kRobotToCamFR;
...
public class CameraIOPhoton implements CameraIO {
    ...
    public CameraIOPhoton(Drive robotDrive, int index) {
        ...
        if (Robot.isSimulation()) {
            ...
            cameraProp.setCalibration(640, 500, Rotation2d.fromDegrees(60));
